<x-app-layout>
    ...
    <div class="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-sm">
        <p class="text-lg text-gray-700 dark:text-gray-300 mb-6">Tem certeza que deseja excluir este departamento?</p>

        <form action="{{ route('departamentos.destroy', ['departamento' => $departamento->id]) }}" method="post" class="space-y-4">
            @csrf
