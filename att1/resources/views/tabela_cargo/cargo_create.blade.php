        ...
        <form action="{{ route('cargos.store') }}" method="post"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nome" id="nome" placeholder="Nome"
                    value="{{ old('nome') }}"
                    class="shadow appearance-none border @error('nome') border-red-500 @enderror rounded w-full py-2 px-3 text-gray-700 dark:text-gray-300 dark:bg-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-indigo-500">
