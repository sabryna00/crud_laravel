...
<body class="bg-gray-100 dark:bg-gray-900 font-sans text-gray-900 dark:text-gray-100">
    ...
    <div class="flex justify-center items-center min-h-screen">
        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8 max-w-sm w-full">
            <h2 class="text-2xl font-semibold text-center text-gray-800 dark:text-gray-100 mb-6">Editar Turno</h2>
            ...
            <form action="{{ route('turnos.update', ['turno' => $turno->id]) }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nome" id="nome" value="{{ $turno->nome }}"
                ...
                <div class="mt-6">
                    <button type="submit"
                        class="w-full py-2 px-4 bg-gray-600 text-white text-sm font-medium rounded-lg shadow-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50">
                        Atualizar
                    </button>
                </div>
            </form>
